...
################################################################################
## Form generated from reading UI file 'PyDAQ_Firmware_ArduinoLZvXXI.ui'
##
...
"")
        ...
        self.widget = QWidget(Firmware)
        self.widget.setObjectName(u"widget")
        self.widget.setMaximumSize(QSize(16777215, 50))
        self.horizontalLayout = QHBoxLayout(self.widget)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.upload_button = QPushButton(self.widget)
        self.upload_button.setObjectName(u"upload_button")
        self.upload_button.setMaximumSize(QSize(120, 16777215))
        ...
        self.widget_2 = QWidget(Firmware)
        ...
        self.retranslateUi(Firmware)

        QMetaObject.connectSlotsByName(Firmware)
    # setupUi

    def retranslateUi(self, Firmware):
