...
################################################################################
## Form generated from reading UI file 'PyDAQ_lqr_control_Arduino_widgetbMykhf.ui'
##
...
class Ui_Arduino_LQR_Control(object):
    def setupUi(self, Arduino_LQR_Control):
        ...
        Arduino_LQR_Control.resize(713, 709)
...
"")
        ...
        self.gridLayout_2.addWidget(self.widget_12, 14, 2, 1, 1, Qt.AlignmentFlag.AlignLeft)
        ...
        self.gridLayout_2.addWidget(self.widget_10, 9, 2, 1, 1)
        ...
        self.widget_reference = QWidget(self.widget)
        self.widget_reference.setObjectName(u"widget_reference")
        self.horizontalLayout_4 = QHBoxLayout(self.widget_reference)
        self.horizontalLayout_4.setObjectName(u"horizontalLayout_4")
        self.yes_reference_radio = QRadioButton(self.widget_reference)
        self.reference_radio_group = QButtonGroup(Arduino_LQR_Control)
        ...
        self.horizontalLayout_4.addWidget(self.yes_reference_radio)

        self.no_reference_radio = QRadioButton(self.widget_reference)
        ...
        self.horizontalLayout_4.addWidget(self.no_reference_radio)


        self.gridLayout_2.addWidget(self.widget_reference, 7, 2, 1, 1, Qt.AlignmentFlag.AlignLeft)
        ...
        self.widget_axes = QWidget(self.widget)
        self.widget_axes.setObjectName(u"widget_axes")
        self.gridLayout_6 = QGridLayout(self.widget_axes)
        self.gridLayout_6.setObjectName(u"gridLayout_6")
        self.chk_plot_y = QCheckBox(self.widget_axes)
        self.chk_plot_y.setObjectName(u"chk_plot_y")

        self.gridLayout_6.addWidget(self.chk_plot_y, 0, 0, 1, 1)

        self.chk_plot_x = QCheckBox(self.widget_axes)
        self.chk_plot_x.setObjectName(u"chk_plot_x")
        self.chk_plot_x.setChecked(True)

        self.gridLayout_6.addWidget(self.chk_plot_x, 0, 1, 1, 1)

        self.chk_plot_e = QCheckBox(self.widget_axes)
        self.chk_plot_e.setObjectName(u"chk_plot_e")

        self.gridLayout_6.addWidget(self.chk_plot_e, 0, 2, 1, 1)

        self.chk_plot_u = QCheckBox(self.widget_axes)
        self.chk_plot_u.setObjectName(u"chk_plot_u")
        self.chk_plot_u.setChecked(True)

        self.gridLayout_6.addWidget(self.chk_plot_u, 0, 3, 1, 1)


        self.gridLayout_2.addWidget(self.widget_axes, 13, 2, 1, 1, Qt.AlignmentFlag.AlignLeft)
        ...
        self.gridLayout_2.addWidget(self.widget_16, 15, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.line_2, 1, 1, 15, 1)
        ...
        self.gridLayout_2.addWidget(self.label_12, 15, 0, 1, 1, Qt.AlignmentFlag.AlignVCenter)

        self.label_axes = QLabel(self.widget)
        self.label_axes.setObjectName(u"label_axes")

        self.gridLayout_2.addWidget(self.label_axes, 13, 0, 1, 1)
    ...
    def retranslateUi(self, Arduino_LQR_Control):
        ...
        self.yes_reference_radio.setText(QCoreApplication.translate("Arduino_LQR_Control", u"Yes", None))
        self.no_reference_radio.setText(QCoreApplication.translate("Arduino_LQR_Control", u"No", None))
        ...
        self.chk_plot_y.setText(QCoreApplication.translate("Arduino_LQR_Control", u"Outputs (y)", None))
        self.chk_plot_x.setText(QCoreApplication.translate("Arduino_LQR_Control", u"States (x)", None))
        self.chk_plot_e.setText(QCoreApplication.translate("Arduino_LQR_Control", u"State Error (e)", None))
        self.chk_plot_u.setText(QCoreApplication.translate("Arduino_LQR_Control", u"Control Effort (u)", None))
        ...
        self.label.setText(QCoreApplication.translate("Arduino_LQR_Control", u"Reference State?", None))
        ...
        self.label_axes.setText(QCoreApplication.translate("Arduino_LQR_Control", u"Plot axes:", None))
    # retranslateUi
