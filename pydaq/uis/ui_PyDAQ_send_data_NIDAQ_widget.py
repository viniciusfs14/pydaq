...
################################################################################
## Form generated from reading UI file 'PyDAQ_send_data_NIDAQ_widgetEWpgYU.ui'
##
...
"")
    ...
    def retranslateUi(self, NIDAQ_SendData_W):
        ...
        self.label_2.setText(QCoreApplication.translate("NIDAQ_SendData_W", u"AO channel (s):", None))
