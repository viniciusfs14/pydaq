...
################################################################################
## Form generated from reading UI file 'PyDAQ_send_data_NIDAQ_widgetYduscf.ui'
##
...
"")
    ...
    def retranslateUi(self, NIDAQ_SendData_W):
        ...
        self.label_2.setText(QCoreApplication.translate("NIDAQ_SendData_W", u"Channel (s):", None))
