...
class Ui_PRBS_Info(object):
    def setupUi(self, PRBS_Info):
        if not PRBS_Info.objectName():
            PRBS_Info.setObjectName(u"PRBS_Info")
        ...
        PRBS_Info.setStyleSheet(u"QComboBox QAbstractItemView {\n"
...
"	border: 2px solid rgb(255, 255, 255);\n"
"}")
        PRBS_Info.setLocale(QLocale(QLocale.English, QLocale.UnitedStates))
        ...
        self.prbs_bits_in.setObjectName(u"prbs_bits_in")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Ignored)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.prbs_bits_in.sizePolicy().hasHeightForWidth())
        ...
        self.prbs_seed_in.setObjectName(u"prbs_seed_in")
        ...
        self.prbs_tb_var_in.setObjectName(u"prbs_tb_var_in")
    ...
    def retranslateUi(self, PRBS_Info):
        PRBS_Info.setWindowTitle(QCoreApplication.translate("PRBS_Info", u"PRBS Signal Configuration", None))
        self.label.setText(QCoreApplication.translate("PRBS_Info", u"Bits", None))
        self.prbs_seed_in.setInputMask(QCoreApplication.translate("PRBS_Info", u"BBBBBBBBBBBBBBB", None))
        self.prbs_seed_in.setText(QCoreApplication.translate("PRBS_Info", u"101", None))
        self.label_4.setText(QCoreApplication.translate("PRBS_Info", u"Tb_var", None))
        self.label_2.setText(QCoreApplication.translate("PRBS_Info", u"PRBS - Input Informations", None))
        self.label_3.setText(QCoreApplication.translate("PRBS_Info", u"Seed", None))
    # retranslateUi
